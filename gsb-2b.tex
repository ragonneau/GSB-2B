...
\begin{document}
    ...
    However, such information is unavailable or prohibitively expensive to assess in numerous applications, especially when the problems involve experiments or simulations, as is frequently the case in industrial and engineering applications, and noisy nonlinear least-squares problems~\cite{Cartis_Etal_2019} for instance.
    \Gls{dfo} is designed to tackle such problems~\cite{Audet_Hare_2017,Conn_Scheinberg_Vicente_2009b,Larson_Menickelly_Wild_2019}.
    This thesis studies \gls{dfo} methods that exploit interpolation models and develop software based on them.
    It consists of two major parts.
    We first present PDFO, a piece of software we implement for interfacing Powell's \gls{dfo} solvers with MATLAB and Python.
